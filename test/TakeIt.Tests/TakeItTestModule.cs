...
namespace TakeIt.Tests
{
    ...
    public class TakeItTestModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TakeItTestModule).GetAssembly());
        }
        ...
        private void SetupInMemoryDb()
        {
            ...
            IocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<TakeItDbContext>>()
